  ...
  const entrar = async () => {
    ...
    try {
      ...
      if (role === "cliente") {
        ...
        if (!name)
          return Alert.alert("Erro", "Digite seu nome");
      ...
      Alert.alert(
        "Erro de Conexão",
        "A API está rodando no localhost:3000?"
      );
      ...
      {role === "cliente" ? (
        ...
        <View>
          ...
          <View style={{ marginBottom: 10 }}>
            ...
            <Button
              title="Não tenho conta (Registrar Chef)"
